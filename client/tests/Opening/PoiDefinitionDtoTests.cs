...
public sealed class PoiDefinitionDtoTests
{
    ...
    {
        var a = new PoiDefinitionDto("halfgate", true, "E2_AREA", "E1WorldMapPoiCityPatentedTooltipTemplate");
        var b = new PoiDefinitionDto("halfgate", true, "E2_AREA", "E1WorldMapPoiCityPatentedTooltipTemplate");
